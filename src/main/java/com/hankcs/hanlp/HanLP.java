...
public class HanLP {
    ...
    public static final class Config {
         ...
         * 核心词典路径
         */
        public static String[] CoreDictionaryPath = new String[]{"data/dictionary/CoreNatureDictionary.txt"};
        /**
         * 核心词典词性转移矩阵路径
         */
         ...
         * 2元语法词典路径
         */
        public static String[] BiGramDictionaryPath = new String[]{"data/dictionary/CoreNatureDictionary.ngram.txt"};
        ...
        public static String[] getPathArray(String key, String defaultValue, String root, Properties p) {
            String[] pathArray = p.getProperty(key, defaultValue).split(";");
            String prePath = root;
        ...
        static {
            ...
            try {
                ...
                CoreDictionaryPath = getPathArray("CoreDictionaryPath", "data/dictionary/CoreNatureDictionary.txt", root, p);
                ...
                BiGramDictionaryPath = getPathArray("BiGramDictionaryPath", "data/dictionary/CoreNatureDictionary.ngram.txt", root, p);
                ...
                CustomDictionaryPath = getPathArray("CustomDictionaryPath", "data/dictionary/custom/CustomDictionary.txt", root, p);
